<?php
  ...
  $sql = "SELECT p.product_id, p.seller_student_id, p.product_title, d.upload_time FROM product p, data d WHERE p.product_id = d.product_id LIMIT 20;";
  ...
  <body>
    <header>
      ...
      <div id="contents">
        ...
        <h2>. . .</h2>
        <h3> - 주의 - </h3>
        <h5>메인 화면에선 판매 게시글의 상위 20개 게시글만 노출합니다</br>더 많은 정보를 열람하고 싶으실 경우 '구매하기' 창으로 이동해 주세요</h5>
      </div>
    </header>
  </body>
</html>
